...
import com.example.concour.filter.JwtConstant;
...
public class JwtUtil implements Serializable {
    ...
    //addRolesClaim generer le token avec plusiur information (DATE EXPIRATION.....)
    ...
    //valdate token verifier si le user est le meme, date expiration
